<template>
    <div @click.prevent="login" class="active:bg-background-pressed disabled:bg-background-disbaled mt-2 hover:shadow-btn outline-none border google-btn w-1/2 h-12 bg-background-google m-auto flex flex-row items-center align-center md:w-1/3">
